...
import 'package:decoder/utils/url_launcher.dart';
import 'package:decoder/utils/voip/callkeep_manager.dart';
...
class ChatListController extends State<ChatList>
  ...
  bool get displayNavigationBar =>
      !DecoderThemes.isColumnMode(context) &&
  ...
  static const String _serverStoreNamespace = 'im.brigadachat.search.server';
  ...
  void _initReceiveSharingIntent() {
    ...
    if (DecoderApp.gotInitialLink == false) {
      DecoderApp.gotInitialLink = true;
