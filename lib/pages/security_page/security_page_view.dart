...
class SecurityPageView extends StatefulWidget {
  final SecurityPageController controller;

  const SecurityPageView({required this.controller, Key? key}) : super(key: key);

  @override
  _SecurityPageViewState createState() => _SecurityPageViewState();
}
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    GestureDetector(
                    onTap: () {
                     // widget.controller.setAppLockAction();
                      print("Захист доступу");
                    },
                    child: Container(
                          margin: EdgeInsets.only(top: 25),
                          width: double.infinity,
