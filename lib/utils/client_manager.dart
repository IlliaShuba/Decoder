...
import 'package:decoder/utils/custom_http_client.dart';
import 'package:decoder/utils/custom_image_resizer.dart';
import 'package:decoder/utils/flutter_hive_collections_database.dart';
import 'package:decoder/utils/platform_infos.dart';
import 'package:decoder/utils/store.dart';
...
abstract class ClientManager {
  ...
  static Client createClient(String clientName) {
    return Client(
      ...
      databaseBuilder: FlutterHiveCollectionsDatabase.databaseBuilder, //check to this class
      supportedLoginTypes: {
        AuthenticationTypes.password,
        AuthenticationTypes.sso,
      },
      nativeImplementations: nativeImplementations,
      customImageResizer: PlatformInfos.isMobile ? customImageResizer : null, //check to this class
    );
  }
}
