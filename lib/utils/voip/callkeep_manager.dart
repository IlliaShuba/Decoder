...
import 'package:decoder/utils/voip/voip_plugin.dart';
...
class CallKeepManager {
  ...
  String get appName => 'brigadachat';
  ...
  Map<String, dynamic> get alertOptions => <String, dynamic>{
        ...
        'foregroundService': {
          'channelId': 'com.fluffy.brigadachat',
  ...
  Future<CallKeeper> displayIncomingCall(CallSession call) async {
    ...
    await _callKeep.displayIncomingCall(
      call.callId,
      '${call.room.getLocalizedDisplayname()} (brigadachat)',
      localizedCallerName:
          '${call.room.getLocalizedDisplayname()} (brigadachat)',
      handleType: 'number',
