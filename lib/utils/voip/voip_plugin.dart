...
import 'package:decoder/pages/dialer/dialer.dart';
...
import 'package:decoder/utils/voip/user_media_manager.dart';
...
class VoipPlugin with WidgetsBindingObserver implements WebRTCDelegate {
  ...
  void addCallingOverlay(String callId, CallSession call) {
    final context = kIsWeb
        ...
        : DecoderApp.routerKey.currentContext!; // web is weird
      ...
      if (call.direction == CallDirection.kIncoming &&
        ...
        try {
          if (!hasCallingAccount) {
            ScaffoldMessenger.of(DecoderApp.routerKey.currentContext!)
                .showSnackBar(
              const SnackBar(
                content: Text(
